...
export const Projects: FC = () => {
  ...
  const renderItem = useCallback((item: IProject, index: number) => {
  ...
  return (
    <div className='mt-10 flex flex-col gap-7 px-[0.875rem] py-10 sm:px-10 sm:py-20 lg:mt-[3.375rem] lg:gap-[11.25rem]'>
